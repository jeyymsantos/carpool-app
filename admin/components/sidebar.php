    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="hard-drive" class="feather-icon"></i><span class="hide-menu">Cars </span></a>
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        <li class="sidebar-item"><a href="car_config/car_module.php" class="sidebar-link"><span class="hide-menu"> Pending Cars
                                </span></a>
                        </li>
            ...
            <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="credit-card" class="feather-icon"></i><span class="hide-menu">Identification </span></a>
                <ul aria-expanded="false" class="collapse  first-level base-level-line">
                    <li class="sidebar-item"><a href="id_config/id_module.php" class="sidebar-link"><span class="hide-menu"> Pending ID
                            </span></a>
                    </li>
            ...
            <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="dollar-sign" class="feather-icon"></i><span class="hide-menu">Wallet </span></a>
                <ul aria-expanded="false" class="collapse  first-level base-level-line">
                    <li class="sidebar-item"><a href="wallet_config/wallet_module.php" class="sidebar-link"><span class="hide-menu"> Pending Cash In
                            </span></a>
                    </li>
                    <li class="sidebar-item"><a href="wallet_config/wallet_module.php" class="sidebar-link"><span class="hide-menu"> Pending Cash Out
                            </span></a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Reports </span></a>
                <ul aria-expanded="false" class="collapse  first-level base-level-line">
                    <li class="sidebar-item"><a href="reports/cash_in.php" class="sidebar-link"><span class="hide-menu"> Cash In Transactions
                            </span></a>
                    </li>
                    <li class="sidebar-item"><a href="reports/cash_out.php" class="sidebar-link"><span class="hide-menu"> Cash Out Transactions </span></a>
                    </li>
                    <li class="sidebar-item"><a href="reports/balance.php" class="sidebar-link"><span class="hide-menu"> Balance Tickets </span></a></li>
                    <li class="sidebar-item"><a href="reports/verified_users.php" class="sidebar-link"><span class="hide-menu"> Verified Users </span></a></li>
                </ul>
            </li>
